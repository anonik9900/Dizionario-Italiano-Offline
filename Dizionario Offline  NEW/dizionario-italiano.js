...
//if (top.frames.length > 0){ top.location=self.location;} /* Toglie frame */
...
function AddFavorite(sURL, sDescr) {
  if ((navigator.appName=="Microsoft Internet Explorer")&&
    ...
    var msg = "Con il tuo browser devi aggiungere manualmente\n\rDIZIONARIO ITALIANO ai tuoi preferiti!\n\r";
    if (navigator.appName=="Netscape") msg += "(Per favore digita: CTRL-D)";
    alert(msg);
  }
}
